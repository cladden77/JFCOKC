...
function prelude_theme_scripts() {
  ...
  wp_enqueue_style('remodal-css', 'https://fonts.googleapis.com/css2?family=Noto+Sans:ital,wght@0,400;0,700;1,400;1,700&display=swap' , array(), THEME_VERSION );
  wp_enqueue_style('google-fonts', get_template_directory_uri() . '/assets/css/aos.min.css', array(), THEME_VERSION );
